...
import org.vaadin.tunis.projects.financialapp.Constants;
...
public class Account implements Category, Serializable, Constants {
	...
	public org.vaadin.tunis.projects.financialapp.Currency getCurrency() {
		return org.vaadin.tunis.projects.financialapp.Currency.getCurrencyForCode(getCurrencyCode());
	}
